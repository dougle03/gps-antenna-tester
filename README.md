...
See the code in `cyd-gps-tester.yaml`. It's written in `ESPhome.io` yaml and designed to integrate the outputs into Home Assistant, although it will run entirely standalone and will not recycle if it can't connect to either WiFi or the Home Assistant API.
